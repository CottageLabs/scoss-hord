...
$.extend(!0,edges,{chartjs:{newRadar:function(e){return edges.instantiate(edges.chartjs.Radar,e,edges.newRenderer)},Radar:function(e){this.options=edges.getParam(e.options,{}),this.dataSeriesProperties=edges.getParam(e.dataSeriesProperties,{}),this.title=edges.getParam(e.title,!1),this.description=edges.getParam(e.description,!1),this.anchor=edges.getParam(e.anchor,!1),this.figureLabel=edges.getParam(e.figureLabel,!1),this.download=edges.getParam(e.download,!1),this.downloadText=edges.getParam(e.downloadText,"download"),this.downloadName=edges.getParam(e.downloadName,"image"),this.namespace="edges-chartjs-radar",this.chart=!1,this.draw=function(){var e=this._dataSeriesToDatasets();if(e!==!1)if(this.chart===!1){var s=edges.css_classes(this.namespace,"container",this),a=edges.css_classes(this.namespace,"download-container",this),t=edges.css_classes(this.namespace,"chart",this),i=edges.css_id(this.namespace,"canvas",this),d=edges.css_id_selector(this.namespace,"canvas",this),n=edges.css_id(this.namespace,"download",this),o=edges.css_classes(this.namespace,"title",this),r=edges.css_classes(this.namespace,"desc",this),h=edges.css_classes(this.namespace,"figure",this),c="";this.anchor&&(c='<a name="'+this.anchor+'"></a>');var l="";this.title&&(l='<div class="'+o+'"><h1>'+this.title+"</h1></div>");var g="";this.description&&(g='<div class="'+r+'">'+this.description+"</div>");var p="";this.figureLabel&&(p='<div class="'+h+'">'+this.figureLabel+"</div>");var m='<div class="'+s+'">'+c+l+g+'                        <div class="'+t+'">                            <canvas id="'+i+'" width="400" height="400"></canvas>                            '+p+"                        </div>";this.download&&(m+='<div class="'+a+'"><a href="#" id="'+n+'">'+edges.escapeHtml(this.downloadText)+"</a></div>"),this.component.context.html(m);var v=this.component.context.find(d);if(this.chart=new Chart(v,{type:"radar",data:e,options:this.options}),this.download){var u=edges.css_id_selector(this.namespace,"download",this);edges.on(u,"click",this,"doDownload")}}else{for(var w=0;w<e.datasets.length;w++)this.chart.data.datasets[w].data=e.datasets[w].data,this.chart.data.datasets[w].label=e.datasets[w].label;this.chart.update()}},this._dataSeriesToDatasets=function(){if(this.component.dataSeries===!1||0==this.component.dataSeries.length)return!1;var e={};e.labels=this.component.dataSeries[0].values.map(function(e){return e.label}),e.datasets=[];for(var s=0;s<this.component.dataSeries.length;s++){var a=this.component.dataSeries[s],t={label:edges.getParam(this.component.dataSeriesNameMap[a.key],a.key),data:a.values.map(function(e){return e.value})};this.dataSeriesProperties.hasOwnProperty(a.key)&&$.extend(t,this.dataSeriesProperties[a.key]),e.datasets.push(t)}return e},this.doDownload=function(e){if(this.download){var s=edges.css_id_selector(this.namespace,"canvas",this),a=this.component.jq(s)[0].toDataURL("image/png"),t=document.createElement("a");document.body.appendChild(t),t.style="display: none",t.href=a,t.download=this.downloadName+".png",t.click()}}}}});
var hord={DATA:{},init:function(e){var t=hord.detectMode();"view"===t?hord.view(e):"edit"===t&&hord.edit(e)},view:function(e){var t=e.source_selector,r=e.working_selector,a=(e.editUrlTemplate,e.editUrlRegex,e.viewUrlTemplate,e.viewUrlRegex),s='<div class="row">            <div class="col-sm-12 col-md-6 col-md-offset-3">                <div id="radar-diagrams"></div>            </div>        </div>';$(r).html(s),hord.prePopulateFromURL({selector:t,urlRegex:a});var i=edges.getUrlParams(),o=edges.getParam(i.chart,"main"),n=hord.readConfig({form_selector:t});hord.DATA.config=n;for(var c=[],d=0;d<n.charts.length;d++){var l=n.charts[d];l===o&&$.inArray("view",n.chart_info[l].visibility)>-1&&c.push(hord._makeChartComponent({form_selector:t,chart_id:l,title:n.chart_info[l].name,description:n.chart_info[l].description,figureLabel:"Developed by SPARC Europe in collaboration with DCC",anchor:l,config:n,download:!0}))}var h=edges.newEdge({selector:"#radar-diagrams",template:hord.newRadarDiagramsTemplate(),components:c});hord.DATA.edge=h,hord.cycle({form_selector:t})},edit:function(e){var t=e.source_selector,r=e.working_selector,a=e.editUrlTemplate,s=e.editUrlRegex,i=e.viewUrlTemplate,o=edges.getParam(e.scrollOffset,0),n=$(t).html();$(t).html("");var c='<div class="row">            <div class="col-md-6">                <div class="section-navigation"></div>                <div id="hord"></div>                <div class="section-navigation"></div>            </div>            <div class="col-md-6">                <div id="radar-diagrams"></div>            </div>        </div>';$(r).html(c);var d="#hord";$(d,r).html(n),hord.newSectionManager({form_selector:d,scrollSelector:r,scrollOffset:o}),hord.prePopulateFromURL({selector:d,urlRegex:s});var l=hord.readConfig({form_selector:d});hord.DATA.config=l;for(var h=[],g=0;g<l.charts.length;g++){var m=l.charts[g];$.inArray("edit",l.chart_info[m].visibility)>-1&&h.push(hord._makeChartComponent({form_selector:d,chart_id:m,config:l}))}h.push(hord.newPersistentLink({id:"persistent-link",category:"radar",sourceChart:"main",resource:d,editUrlTemplate:a,viewUrlTemplate:i,listBookmarks:!0,manageUrl:!0}));var u=edges.newEdge({selector:"#radar-diagrams",template:hord.newRadarDiagramsTemplate(),components:h});hord.DATA.edge=u;var f=$("[data-hord=urls]"),v=f.attr("id");f.html('<div id="persistent-link-in-form"></div>');var p=[hord.newPersistentLink({id:"persistent-link-in-form",sourceChart:"main",resource:d,editUrlTemplate:a,viewUrlTemplate:i,listCharts:!0,listBookmarks:!1,manageUrl:!1})],_=edges.newEdge({selector:"#"+v,components:p});hord.DATA.urls_edge=_,$("[data-hord]",d).on("change",function(e){hord.cycle({form_selector:d,update_date:!0})}),hord.cycle({form_selector:d})},readConfig:function(e){var t=e.form_selector,r={},a=$("[data-hord=config]",t);r.charts=a.attr("data-hord-charts").split(",").map(function(e){return e.trim()}),r.chart_info={};for(var s=0;s<r.charts.length;s++){var i=r.charts[s];r.chart_info[i]={};var o=a.attr("data-hord-charts-"+i+"-name");o&&(r.chart_info[i].name=o);var n=a.attr("data-hord-charts-"+i+"-size");n&&(r.chart_info[i].size=parseInt(n));var c=a.attr("data-hord-charts-"+i+"-visibility");c&&(r.chart_info[i].visibility=c.split(",").map(function(e){return e.trim()}));var d=a.attr("data-hord-charts-"+i+"-description");d&&(r.chart_info[i].description=d)}return r},_makeChartComponent:function(e){var t=edges.getParam(e.namespace,""),r=e.chart_id,a=e.form_selector,s=e.config,i=edges.getParam(e.download,!1),o=edges.getParam(e.title,!1),n=edges.getParam(e.description,!1),c=edges.getParam(e.anchor,!1),d=edges.getParam(e.figureLabel,!1),l=edges.getParam(e.pointLabels,!0),h=edges.getParam(s.chart_info[r].name,r),g=edges.getParam(s.chart_info[r].size,10);return edges.newChart({id:t+r,category:"radar",dataFunction:hord.dataFunction({chart:r,resource:a}),dataSeriesNameMapFunction:hord.dataSeriesNameMap({resource:a,subtitle:h}),renderer:edges.chartjs.newRadar({title:o,description:n,anchor:c,figureLabel:d,download:i,downloadName:edges.safeId(h),options:{scale:{ticks:{beginAtZero:!0,min:0,max:g,stepSize:1,suggestedMin:0,suggestedMax:g,callback:function(){return""},backdropColor:"rgba(0, 0, 0, 0)"},pointLabels:{display:l}},legend:{labels:{fontStyle:"bold"},onClick:function(){}}},dataSeriesProperties:{results:{fill:!0,backgroundColor:"rgba(87, 153, 199, 0.3)",borderColor:"#5799C7",borderWidth:4,pointBackgroundColor:"#5799C7",pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:"rgba(220,220,220,1)"}}})})},detectMode:function(){var e=edges.getUrlParams();return edges.getParam(e.mode,"edit")},dataSeriesNameMap:function(e){var t=e.resource,r=e.subtitle;return function(e){if(!e.edge.resources.hasOwnProperty(t))return{};var a=r,s=e.edge.resources[t].title;if(""!=s&&(a+=" - "+s,hord.DATA.date)){var i=hord.formatDate(hord.DATA.date);a+=", "+i}return{results:a}}},formatDate:function(e){var t=e.getUTCDate(),r=e.getUTCMonth(),a=e.getUTCFullYear(),s=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];return t+" "+s[r]+" "+a},prePopulateFromURL:function(e){var t=e.selector,r=e.urlRegex,a=r.exec(window.location.href);if(null!==a){var s=atob(a[1]).split("|");if(2===s.length){var i=s[0].split(",");if(2===i.length&&($("input[data-hord=title]").val(i[0]),hord.DATA.date=new Date(parseInt(i[1])),""!==s[1]))for(var o=s[1].split(","),n=0;n<o.length;n++){var c=o[n],d=c.split("#"),l="input[name="+d[0]+"]";2==d.length&&(l+="[value="+d[1]+"]"),$(l,t).prop("checked",!0)}}}},cycle:function(e){var t=edges.getParam(e.update_date,!1);hord.readForm({selector:e.form_selector}),hord.DATA.date&&t!==!0||(hord.DATA.date=new Date),hord.DATA.edge.cycle(),hord.DATA.hasOwnProperty("urls_edge")&&hord.DATA.urls_edge.cycle()},newRadarDiagramsTemplate:function(e){return edges.instantiate(hord.RadarDiagramsTemplate,e,edges.newTemplate)},RadarDiagramsTemplate:function(e){this.namespace="hord-radar-diagrams",this.draw=function(e){this.edge=e;for(var t=edges.css_classes(this.namespace,"container"),r=edges.css_classes(this.namespace,"section"),a='<div class="'+t+'">',s=e.category("radar"),i=0;i<s.length;i++)a+='<div class="'+r+'">                    <div class="row"><div class="col-md-12"><div id="'+s[i].id+'"></div></div></div>                </div>';e.context.html(a)}},newPersistentLink:function(e){return edges.instantiate(hord.PersistentLink,e,edges.newComponent)},PersistentLink:function(e){this.sourceChart=e.sourceChart,this.resource=e.resource,this.editUrlTemplate=e.editUrlTemplate,this.viewUrlTemplate=e.viewUrlTemplate,this.manageUrl=e.manageUrl,this.listCharts=edges.getParam(e.listCharts,!1),this.listBookmarks=edges.getParam(e.listBookmarks,!1),this.renderer=hord.newPersistentLinkRenderer({manageUrl:this.manageUrl}),this.summary="",this.chartInfo=[],this.synchronise=function(){if(this.summary="",this.edge.resources.hasOwnProperty(this.resource)){var e=this.edge.resources[this.resource].title,t="";e&&(t=hord.DATA.date.getTime()),this.summary+=e+","+t+"|";var r="",a=this.edge.resources[this.resource].charts[this.sourceChart];for(var s in a)a[s].selected_values.length>0&&(0!=r.length&&(r+=","),r+=a[s].selected_values.join(","));if(this.summary+=r,this.chartInfo=[],this.listCharts)for(var i=0;i<hord.DATA.config.charts.length;i++){var o=hord.DATA.config.charts[i],n=hord.DATA.config.chart_info[o];this.chartInfo.push({id:o,title:n.name,description:n.description})}}}},newPersistentLinkRenderer:function(e){return edges.instantiate(hord.PersistentLinkRenderer,e,edges.newRenderer)},PersistentLinkRenderer:function(e){this.manageUrl=e.manageUrl,this.namespace="hord-persistent-link",this.draw=function(){var e=btoa(this.component.summary),t=this.component.editUrlTemplate.replace("{summary}",e),r=this.component.viewUrlTemplate.replace("{summary}",e),a="";if(this.component.listBookmarks&&(a='<p>To return to this form and make changes you can <a href="'+t+'">bookmark this page</a>'),this.component.listCharts){a+="<p>The following charts are available for you:</p>";for(var s=0;s<this.component.chartInfo.length;s++){var i=this.component.chartInfo[s],o=r.replace("{chart}",i.id);a+='<p><strong><a href="'+o+'">'+i.title+"</a></strong> - "+i.description+"<br></p>"}}this.component.context.html(a),this.manageUrl&&window.history.replaceState&&window.history.replaceState({},null,t)}},dataFunction:function(e){var t=e.resource,r=e.chart;return function(e){if(!e.edge.resources.hasOwnProperty(t))return[];for(var a=e.edge.resources[t].charts[r],s=[],i=0;i<hord.DATA.axes.length;i++){var o=hord.DATA.axes[i].id;if(a.hasOwnProperty(o)){var n=a[o].name,c=a[o].length;s.push({label:n,value:c})}}return[{key:"results",values:s}]}},readForm:function(e){for(var t=e.selector,r=$("[data-hord]",t),a=[],s=[],i="",o=0;o<r.length;o++){var n=$(r[o]),c=n.attr("data-hord");if("axis"===c){var d=hord._readAxisConfig(n);a.push(d)}else if("value"===c){var l=hord._readValueConfig(n);s.push(l)}else"title"===c&&(i=n.val())}var h=hord._listCharts({axes:a}),g={};g.title=i,g.charts={};for(var o=0;o<h.length;o++){var m=h[o];g.charts[m]={};for(var u=hord._listChartAxes({chart:m,axes:a}),f=0;f<u.length;f++){var v=u[f],p=hord._getLength({chart:m,axisid:v.id,values:s});g.charts[m][v.id]={name:v.name,length:p.length,selected_values:p.selected}}}hord.DATA.axes=a,hord.DATA.values=s,hord.DATA.charts=h,hord.DATA.data=g,hord.DATA.edge.resources[t]=hord.DATA.data,hord.DATA.hasOwnProperty("urls_edge")&&(hord.DATA.urls_edge.resources[t]=hord.DATA.data)},_getLength:function(e){for(var t=e.chart,r=e.axisid,a=e.values,s=0,i=[],o=0;o<a.length;o++){var n=a[o];if(n.axisid===r&&n.checked===!0&&t in n.weights){s+=n.weights[t];var c=n.name;n.value&&(c+="#"+n.value),i.push(c)}}return{length:s,selected:i}},_listChartAxes:function(e){for(var t=e.chart,r=e.axes,a=[],s=0;s<r.length;s++){var i=r[s];$.inArray(t,i.charts)>-1&&a.push(i)}return a},_listCharts:function(e){for(var t=e.axes,r=new Set,a=0;a<t.length;a++)for(var s=t[a],i=0;i<s.charts.length;i++){var o=s.charts[i];r.add(o)}return Array.from(r)},_readAxisConfig:function(e){var t=e.attr("data-hord-axisid"),r=e.attr("data-hord-charts"),a=e.attr("data-hord-name");return r=r?r.split(",").map(function(e){return e.trim()}):[],a||(a=e.text()),{id:t,charts:r,name:a}},_readValueConfig:function(e){var t=e.attr("data-hord-axisid"),r=e.attr("data-hord-weight"),a=e.attr("data-hord-charts"),s=e.attr("name"),i=e.attr("value"),o=e.is(":checked");r=r?parseFloat(r):1,a=a?a.split(",").map(function(e){return e.trim()}):[];for(var n={},c=0;c<a.length;c++){var d=e.attr("data-hord-weight-"+a[c]);d=d?parseFloat(d):r,n[a[c]]=d}return{axisid:t,name:s,value:i,checked:o,weights:n}},newSectionManager:function(e){return edges.instantiate(hord.SectionManager,e)},SectionManager:function(e){this.form_selector=e.form_selector,this.scrollSelector=e.scrollSelector,this.scrollOffset=edges.getParam(e.scrollOffset,0),this.lastButtonIsFinish=edges.getParam(e.lastButtonIsFinish,!0),this.context=!1,this.currentSection=0,this.maxSection=0,this.sections=!1,this.namespace="section-manager",this.init=function(){this.context=$(this.form_selector),this._drawNavigation(),this.sections=this.context.find("section"),this.maxSection=this.sections.length,this._activateSection({section:0})},this._activateSection=function(e){for(var t=e.section,r=0;r<this.sections.length;r++){var a=$(this.sections[r]);a.attr("data-section",String(r)),a.hide(),r===t&&a.show()}this.currentSection=t,this._setPrevNext()},this._drawNavigation=function(){var e=edges.css_classes(this.namespace,"prev"),t=edges.css_classes(this.namespace,"next"),r='<span class="'+e+'"></span>';r+='<span class="'+t+'"></span>';$(".section-navigation").html(r)},this._setPrevNext=function(){var e=this.currentSection-1,t=this.currentSection+1;0>e&&(e=!1),t>=this.maxSection&&(t=!1);var r=edges.css_class_selector(this.namespace,"prev"),a=edges.css_class_selector(this.namespace,"next");if(e===!1)$(r).html("");else{var s=edges.css_classes(this.namespace,"prev-link"),i='<a href="#" class="'+s+' btn btn-info" data-target="'+String(e)+'">&laquo; previous section</a>';$(r).html(i);var o=edges.css_class_selector(this.namespace,"prev-link");edges.on(o,"click",this,"linkClicked")}if(t===!1)$(a).html("");else{var n=edges.css_classes(this.namespace,"next-link"),c="next section &raquo;";this.lastButtonIsFinish&&t===this.maxSection-1&&(c="finish &raquo;");var i='<a href="#" class="'+n+' btn btn-info" data-target="'+String(t)+'">'+c+"</a>";$(a).html(i);var d=edges.css_class_selector(this.namespace,"next-link");edges.on(d,"click",this,"linkClicked")}},this.linkClicked=function(e){var t=$(e).attr("data-target");this._activateSection({section:parseInt(t)}),this.doScroll()},this.doScroll=function(){var e=$(this.scrollSelector).offset().top-this.scrollOffset,t=$("html,body").scrollTop();t>e&&$("html,body").animate({scrollTop:e},500)},this.init()}};
