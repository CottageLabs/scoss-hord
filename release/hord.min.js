...
var hord={DATA:{},init:function(e){var t=hord.detectMode();"view"===t?hord.view(e):"edit"===t&&hord.edit(e)},view:function(e){var t=e.source_selector,r=e.working_selector,a=(e.editUrlTemplate,e.editUrlRegex,e.viewUrlTemplate,e.viewUrlRegex),s='<div class="row">            <div class="col-sm-12 col-md-6 col-md-offset-3">                <div id="radar-diagrams"></div>            </div>        </div>';$(r).html(s),hord.prePopulateFromURL({selector:t,urlRegex:a});var i=hord.readConfig({form_selector:t});hord.DATA.config=i;for(var o=[],n=0;n<i.charts.length;n++){var d=i.charts[n];$.inArray("view",i.chart_info[d].visibility)>-1&&o.push(hord._makeChartComponent({form_selector:t,chart_id:d,title:i.chart_info[d].name,description:i.chart_info[d].description,figureLabel:"Developed by SPARC Europe in collaboration with DCC",anchor:d,config:i,download:!0}))}var c=edges.newEdge({selector:"#radar-diagrams",template:hord.newRadarDiagramsTemplate(),components:o});hord.DATA.edge=c,hord.cycle({form_selector:t})},edit:function(e){var t=e.source_selector,r=e.working_selector,a=e.editUrlTemplate,s=e.editUrlRegex,i=e.viewUrlTemplate,o=(e.viewUrlRegex,edges.getParam(e.scrollOffset,0)),n=$(t).html();$(t).html("");var d='<div class="row">            <div class="col-md-6">                <div class="section-navigation"></div>                <div id="hord"></div>                <div class="section-navigation"></div>            </div>            <div class="col-md-6">                <div id="radar-diagrams"></div>            </div>        </div>';$(r).html(d);var c="#hord";$(c,r).html(n),hord.newSectionManager({form_selector:c,scrollSelector:r,scrollOffset:o}),hord.prePopulateFromURL({selector:c,urlRegex:s});var h=hord.readConfig({form_selector:c});hord.DATA.config=h;for(var l=[],g=0;g<h.charts.length;g++){var m=h.charts[g];$.inArray("edit",h.chart_info[m].visibility)>-1&&l.push(hord._makeChartComponent({form_selector:c,chart_id:m,config:h}))}l.push(hord.newPersistentLink({id:"persistent-link",category:"radar",sourceChart:"main",resource:c,editUrlTemplate:a,viewUrlTemplate:i,manageUrl:!0}));var u=edges.newEdge({selector:"#radar-diagrams",template:hord.newRadarDiagramsTemplate(),components:l});hord.DATA.edge=u;var f=$("[data-hord=urls]"),v=f.attr("id");f.html('<div id="persistent-link-in-form"></div>');var p=edges.newEdge({selector:"#"+v,components:[hord.newPersistentLink({id:"persistent-link-in-form",sourceChart:"main",resource:c,editUrlTemplate:a,viewUrlTemplate:i,listCharts:!0,manageUrl:!1})]});hord.DATA.urls_edge=p,$("[data-hord]",c).on("change",function(e){hord.cycle({form_selector:c,update_date:!0})}),hord.cycle({form_selector:c})},readConfig:function(e){var t=e.form_selector,r={},a=$("[data-hord=config]",t);r.charts=a.attr("data-hord-charts").split(",").map(function(e){return e.trim()}),r.chart_info={};for(var s=0;s<r.charts.length;s++){var i=r.charts[s];r.chart_info[i]={};var o=a.attr("data-hord-charts-"+i+"-name");o&&(r.chart_info[i].name=o);var n=a.attr("data-hord-charts-"+i+"-size");n&&(r.chart_info[i].size=parseInt(n));var d=a.attr("data-hord-charts-"+i+"-visibility");d&&(r.chart_info[i].visibility=d.split(",").map(function(e){return e.trim()}));var c=a.attr("data-hord-charts-"+i+"-description");c&&(r.chart_info[i].description=c)}return r},_makeChartComponent:function(e){var t=e.chart_id,r=e.form_selector,a=e.config,s=edges.getParam(e.download,!1),i=edges.getParam(e.title,!1),o=edges.getParam(e.description,!1),n=edges.getParam(e.anchor,!1),d=edges.getParam(e.figureLabel,!1),c=edges.getParam(a.chart_info[t].name,t),h=edges.getParam(a.chart_info[t].size,10);return edges.newChart({id:t,category:"radar",dataFunction:hord.dataFunction({chart:t,resource:r}),dataSeriesNameMapFunction:hord.dataSeriesNameMap({resource:r,subtitle:c}),renderer:edges.chartjs.newRadar({title:i,description:o,anchor:n,figureLabel:d,download:s,downloadName:edges.safeId(c),options:{scale:{ticks:{beginAtZero:!0,min:0,max:h,stepSize:1,suggestedMin:0,suggestedMax:h,callback:function(){return""},backdropColor:"rgba(0, 0, 0, 0)"}},legend:{labels:{fontStyle:"bold"},onClick:function(){}}},dataSeriesProperties:{results:{fill:!0,backgroundColor:"rgba(87, 153, 199, 0.3)",borderColor:"#5799C7",pointBackgroundColor:"#5799C7",pointBorderColor:"#fff",pointHoverBackgroundColor:"#fff",pointHoverBorderColor:"rgba(220,220,220,1)"}}})})},detectMode:function(){var e=edges.getUrlParams();return edges.getParam(e.mode,"edit")},dataSeriesNameMap:function(e){var t=e.resource,r=e.subtitle;return function(e){if(!e.edge.resources.hasOwnProperty(t))return{};var a=r,s=e.edge.resources[t].title;if(""!=s&&(a+=" - "+s,hord.DATA.date)){var i=hord.formatDate(hord.DATA.date);a+=", "+i}return{results:a}}},formatDate:function(e){var t=e.getUTCDate(),r=e.getUTCMonth(),a=e.getUTCFullYear(),s=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"];return t+" "+s[r]+" "+a},prePopulateFromURL:function(e){var t=e.selector,r=e.urlRegex,a=r.exec(window.location.href);if(null!==a){var s=atob(a[1]).split("|");if(2===s.length){var i=s[0].split(",");if(2===i.length&&($("input[data-hord=title]").val(i[0]),hord.DATA.date=new Date(parseInt(i[1])),""!==s[1]))for(var o=s[1].split(","),n=0;n<o.length;n++){var d=o[n],c="input[name="+d+"]";$(c,t).prop("checked",!0)}}}},cycle:function(e){var t=edges.getParam(e.update_date,!1);hord.readForm({selector:e.form_selector}),hord.DATA.date&&t!==!0||(hord.DATA.date=new Date),hord.DATA.edge.cycle(),hord.DATA.hasOwnProperty("urls_edge")&&hord.DATA.urls_edge.cycle()},newRadarDiagramsTemplate:function(e){return edges.instantiate(hord.RadarDiagramsTemplate,e,edges.newTemplate)},RadarDiagramsTemplate:function(e){this.namespace="hord-radar-diagrams",this.draw=function(e){this.edge=e;for(var t=edges.css_classes(this.namespace,"container"),r=edges.css_classes(this.namespace,"section"),a='<div class="'+t+'">',s=e.category("radar"),i=0;i<s.length;i++)a+='<div class="'+r+'">                    <div class="row"><div class="col-md-12"><div id="'+s[i].id+'"></div></div></div>                </div>';e.context.html(a)}},newPersistentLink:function(e){return edges.instantiate(hord.PersistentLink,e,edges.newComponent)},PersistentLink:function(e){this.sourceChart=e.sourceChart,this.resource=e.resource,this.editUrlTemplate=e.editUrlTemplate,this.viewUrlTemplate=e.viewUrlTemplate,this.manageUrl=e.manageUrl,this.listCharts=edges.getParam(e.listCharts,!1),this.renderer=hord.newPersistentLinkRenderer({manageUrl:this.manageUrl}),this.summary="",this.chartInfo=[],this.synchronise=function(){if(this.summary="",this.edge.resources.hasOwnProperty(this.resource)){var e=this.edge.resources[this.resource].title,t="";e&&(t=hord.DATA.date.getTime()),this.summary+=e+","+t+"|";var r="",a=this.edge.resources[this.resource].charts[this.sourceChart];for(var s in a)a[s].selected_values.length>0&&(0!=r.length&&(r+=","),r+=a[s].selected_values.join(","));if(this.summary+=r,this.chartInfo=[],this.listCharts)for(var i=0;i<hord.DATA.config.charts.length;i++){var o=hord.DATA.config.charts[i],n=hord.DATA.config.chart_info[o];this.chartInfo.push({id:o,title:n.name,description:n.description})}}}},newPersistentLinkRenderer:function(e){return edges.instantiate(hord.PersistentLinkRenderer,e,edges.newRenderer)},PersistentLinkRenderer:function(e){this.manageUrl=e.manageUrl,this.namespace="hord-persistent-link",this.draw=function(){var e=btoa(this.component.summary),t=this.component.editUrlTemplate.replace("{summary}",e),r=this.component.viewUrlTemplate.replace("{summary}",e),a="<p>To return to this form and make changes, bookmark the following URL: ";if(a+='<span style="word-wrap: break-word"><a href="'+t+'">'+t+"</a></span></p>",a+="<p>To view or share the diagrams, bookmark the following URL: ",a+='<span style="word-wrap: break-word"><a href="'+r+'">'+r+"</a></span></p>",this.component.listCharts){a+="<p>The following charts are available for you:</p>";for(var s=0;s<this.component.chartInfo.length;s++){var i=this.component.chartInfo[s],o=r+"#"+edges.safeId(i.id);a+="<p><strong>"+i.title+"</strong> - "+i.description+'<br><span style="word-wrap: break-word"><a href="'+o+'">'+o+"</a></span></p>"}}this.component.context.html(a),this.manageUrl&&window.history.replaceState&&window.history.replaceState({},null,t)}},dataFunction:function(e){var t=e.resource,r=e.chart;return function(e){if(!e.edge.resources.hasOwnProperty(t))return[];for(var a=e.edge.resources[t].charts[r],s=[],i=0;i<hord.DATA.axes.length;i++){var o=hord.DATA.axes[i].id;if(a.hasOwnProperty(o)){var n=a[o].name,d=a[o].length;s.push({label:n,value:d})}}return[{key:"results",values:s}]}},readForm:function(e){for(var t=e.selector,r=$("[data-hord]",t),a=[],s=[],i="",o=0;o<r.length;o++){var n=$(r[o]),d=n.attr("data-hord");if("axis"===d){var c=hord._readAxisConfig(n);a.push(c)}else if("value"===d){var h=hord._readValueConfig(n);s.push(h)}else"title"===d&&(i=n.val())}var l=hord._listCharts({axes:a}),g={};g.title=i,g.charts={};for(var o=0;o<l.length;o++){var m=l[o];g.charts[m]={};for(var u=hord._listChartAxes({chart:m,axes:a}),f=0;f<u.length;f++){var v=u[f],p=hord._getLength({chart:m,axisid:v.id,values:s});g.charts[m][v.id]={name:v.name,length:p.length,selected_values:p.selected}}}hord.DATA.axes=a,hord.DATA.values=s,hord.DATA.charts=l,hord.DATA.data=g,hord.DATA.edge.resources[t]=hord.DATA.data,hord.DATA.hasOwnProperty("urls_edge")&&(hord.DATA.urls_edge.resources[t]=hord.DATA.data)},_getLength:function(e){for(var t=e.chart,r=e.axisid,a=e.values,s=0,i=[],o=0;o<a.length;o++){var n=a[o];n.axisid===r&&n.checked===!0&&t in n.weights&&(s+=n.weights[t],i.push(n.name))}return{length:s,selected:i}},_listChartAxes:function(e){for(var t=e.chart,r=e.axes,a=[],s=0;s<r.length;s++){var i=r[s];$.inArray(t,i.charts)>-1&&a.push(i)}return a},_listCharts:function(e){for(var t=e.axes,r=new Set,a=0;a<t.length;a++)for(var s=t[a],i=0;i<s.charts.length;i++){var o=s.charts[i];r.add(o)}return Array.from(r)},_readAxisConfig:function(e){var t=e.attr("data-hord-axisid"),r=e.attr("data-hord-charts"),a=e.attr("data-hord-name");return r=r?r.split(",").map(function(e){return e.trim()}):[],a||(a=e.text()),{id:t,charts:r,name:a}},_readValueConfig:function(e){var t=e.attr("data-hord-axisid"),r=e.attr("data-hord-weight"),a=e.attr("data-hord-charts"),s=e.attr("name"),i=e.is(":checked");r=r?parseFloat(r):1,a=a?a.split(",").map(function(e){return e.trim()}):[];for(var o={},n=0;n<a.length;n++){var d=e.attr("data-hord-weight-"+a[n]);d=d?parseFloat(d):r,o[a[n]]=d}return{axisid:t,name:s,checked:i,weights:o}},newSectionManager:function(e){return edges.instantiate(hord.SectionManager,e)},SectionManager:function(e){this.form_selector=e.form_selector,this.scrollSelector=e.scrollSelector,this.scrollOffset=edges.getParam(e.scrollOffset,0),this.lastButtonIsFinish=edges.getParam(e.lastButtonIsFinish,!0),this.context=!1,this.currentSection=0,this.maxSection=0,this.sections=!1,this.namespace="section-manager",this.init=function(){this.context=$(this.form_selector),this._drawNavigation(),this.sections=this.context.find("section"),this.maxSection=this.sections.length,this._activateSection({section:0})},this._activateSection=function(e){for(var t=e.section,r=0;r<this.sections.length;r++){var a=$(this.sections[r]);a.attr("data-section",String(r)),a.hide(),r===t&&a.show()}this.currentSection=t,this._setPrevNext()},this._drawNavigation=function(){var e=edges.css_classes(this.namespace,"prev"),t=edges.css_classes(this.namespace,"next"),r='<span class="'+e+'"></span>';r+='<span class="'+t+'"></span>';$(".section-navigation").html(r)},this._setPrevNext=function(){var e=this.currentSection-1,t=this.currentSection+1;0>e&&(e=!1),t>=this.maxSection&&(t=!1);var r=edges.css_class_selector(this.namespace,"prev"),a=edges.css_class_selector(this.namespace,"next");if(e===!1)$(r).html("");else{var s=edges.css_classes(this.namespace,"prev-link"),i='<a href="#" class="'+s+' btn btn-info" data-target="'+String(e)+'">&laquo; previous section</a>';$(r).html(i);var o=edges.css_class_selector(this.namespace,"prev-link");edges.on(o,"click",this,"linkClicked")}if(t===!1)$(a).html("");else{var n=edges.css_classes(this.namespace,"next-link"),d="next section &raquo;";this.lastButtonIsFinish&&t===this.maxSection-1&&(d="finish &raquo;");var i='<a href="#" class="'+n+' btn btn-info" data-target="'+String(t)+'">'+d+"</a>";$(a).html(i);var c=edges.css_class_selector(this.namespace,"next-link");edges.on(c,"click",this,"linkClicked")}},this.linkClicked=function(e){var t=$(e).attr("data-target");this._activateSection({section:parseInt(t)}),this.doScroll()},this.doScroll=function(){var e=$(this.scrollSelector).offset().top-this.scrollOffset,t=$("html,body").scrollTop();t>e&&$("html,body").animate({scrollTop:e},500)},this.init()}};
